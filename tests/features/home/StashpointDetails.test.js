...
import { StashpointDetails } from 'src/features/home/StashpointDetails';

describe('home/StashpointDetails', () => {
  it('renders body correctly when open = true', () => {
    const props = {
      home: {},
      open: true,
      close: () => null,
    ...
    const renderedComponent = shallow(
        <StashpointDetails {...props}/>
    );

    expect(
      renderedComponent.find('.home-stashpoint-details')).to.exist
  });
});
